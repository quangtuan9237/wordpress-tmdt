...
Accept Credit Cards, Debit Cards, Google Pay, Apple Pay, Alipay, SEPA, Klarna, WeChatPay, and Afterpay/Clearpay in your WooCommerce store via the Stripe payment gateway.

== Description ==

### Introduction ###
Stripe Payment Plugin for WooCommerce lets you accept credit cards/debit cards (Mastercard, Visa, American Express, Discover, JCB, Diners Club), Alipay, Apple Pay, Google Pay, SEPA, Klarna, Afterpay/Clearpay, and WeChat pay within your website via the Stripe Payment Gateway.
 ...
 * Accept Afterpay/clearpay, WeChat pay [New]
 * Let customers save card details for easy checkout experience [New]
 ...
 * Accept payments via SEPA
 * Accept payments via Klarna
...
### About Google Pay ###
Google Pay is a digital wallet platform and online payment system developed by Google to allow transaction via mobile devices. Google Pay enables users to make payments with Android phones, tablets, or watches. 
...
###About Afterpay/Clearchatpay###
Afterpay is an online payment platform that allows shoppers to make weekly payments on items purchased until they are paid in full. In UK after pay is known as Clearchatpay.

###About WeChatPay###
WeChat Pay is a mobile payment and digital wallet service based in China that allows users make mobile payments and online transactions.
...
9. Stripe WeChat Pay
10. Stripe Afterpay
11. Stripe Overview Page
12. Stripe General Settings
