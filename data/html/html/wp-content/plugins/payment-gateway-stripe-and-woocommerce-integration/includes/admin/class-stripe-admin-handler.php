        ...
        <div class="wrap">
            ...
            <div class="eh_settings_left">
                ...
                <a href="?page=wt_stripe_menu&tab=general_settings" class="nav-tab <?php echo $active_tab == 'general_settings' ? 'eh-nav-tab-active stripe' : 'stripe'; ?>"><?php  _e('General Settings','payment-gateway-stripe-and-woocommerce-integration'); ?></a>
                    ...
                    <a href="?page=wt_stripe_menu&tab=payment_request" class="nav-tab <?php echo $active_tab == 'payment_request' ? 'eh-nav-tab-active stripe' : 'stripe'; ?>"><?php  _e('Payment Request Button','payment-gateway-stripe-and-woocommerce-integration'); ?></a>
                    ...
                    <a href="?page=wt_stripe_menu&tab=alipay" class="nav-tab <?php echo ($active_tab == 'local' || $active_tab == 'alipay' || $active_tab == 'sepa' || $active_tab == 'klarna' || $active_tab == 'afterpay' || $active_tab == 'wechat') ? 'eh-nav-tab-active stripe' : 'Local Gateways'; ?>"><?php  _e('Local Gateways','payment-gateway-stripe-and-woocommerce-integration'); ?></a>
