    ...
    public function init_form_fields() {
        ...
        $this->form_fields = array(
            ...
            'eh_stripe_capture' => array(
                ...
                'label' => __('Enable', 'payment-gateway-stripe-and-woocommerce-integration'),
                'type' => 'checkbox',
                'description' => __('Disable to capture payments later manually from Stripe dashboard/overview/order details page. Uncaptured payment will expire in 7 days. <br><br>Alipay, WeChat Pay and SEPA Payment does not allow to manually capture payments later.', 'payment-gateway-stripe-and-woocommerce-integration'),
                'default' => 'yes',
