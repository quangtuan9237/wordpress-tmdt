    ...
    public function init_form_fields() {
        ...
        $this->form_fields = array(
            ...
            'eh_afterpay_desc' => array(
                'type' => 'title',
                'description' => sprintf("<div class='wt_info_div'><p> " . __('Stripe accounts in Australia, Canada, New Zealand, Ireland, the United Kingdom, and the United States can accept Afterpay payments with local currency settlement.', 'payment-gateway-stripe-and-woocommerce-integration') . "</p> </div><p><a target='_blank' href='https://www.webtoffee.com/woocommerce-stripe-payment-gateway-plugin-user-guide/#afterpay'>  ".__('Read documentation', 'payment-gateway-stripe-and-woocommerce-integration')." </a></p>"),
            ),
